...
<div class='panel'>
    <div class='panel-heading'>
        <h2 class='panel-title text-center'>Transaksi Beras Masuk Ke Gudang</h2>
    </div>
    <div class='panel-body'>
        <form action="t_trans.php" method="POST">  
            ...
            <div class="form-group">
                <input class="form-control input-lg" type="text" name="nama_client" placeholder="Client Pemasok">
            </div>
